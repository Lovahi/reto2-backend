...
class GameService
{
    ...
    public function getGameById(int $id): ?GameDTO
    {
        ...
        return new GameDTO($game->getId(), $game->getTitle(), $game->getGenre(), $game->getPlatforms(), $game->getImage(), $game->getDescription());
    }

    public function getAllGames(): array
    {
        $games = $this->GameRepository->getAllGames();
        return array_map(fn($game) => new GameDTO($game->getId(), $game->getTitle(), $game->getGenre(), $game->getPlatforms(), $game->getImage(), $game->getDescription()), $games);
    }
